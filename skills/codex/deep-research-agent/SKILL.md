...
description: Submit and control deep-research-agent runs from Codex through the supported CLI or HTTP job boundary. Use for research requests, run status, gate approval, redirect, or cancellation.
---
